            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <form action="{{ route('permissions.index') }}" method="GET" class="flex-grow mr-2 flex">
                            <input type="text" name="search" placeholder="Cari Permission" class="border border-gray-300 rounded-lg p-2 w-full " value="{{ request('search') }}">
