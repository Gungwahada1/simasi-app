        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ route('subjects.index') }}" class="inline-flex items-center px-3 py-2 my-0.5 text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 rounded-lg shadow">
                        {{ __('Back') }}
                    </a>
                </div>
            </div>
