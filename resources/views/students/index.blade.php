            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <form action="{{ route('students.index') }}" method="GET" class="flex-grow mr-2 flex">
                            <input type="text" name="search" placeholder="Cari Student" class="border border-gray-300 rounded-lg p-2 w-full " value="{{ request('search') }}">
                            <button type="submit" class="ml-3 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow">
                                Search
                            </button>
                        </form>
